            ...
            <div class="d-flex flex-column justify-content-between col-md-2 bg-dark min-vh-100">
                <div class="mt-4">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('doctor.patients.search') }}" class="nav-link text-white" id="patientsLink">
                                <i class="fa-solid fa-bed-pulse"></i>
                                <span class="ms-2">Patients Details</span>
                            </a>
                        </li>
                        ...
                        {{-- doctor shedule --}}
                        <li class="nav-item">
                            <a href="{{ route('doctor.schedule') }}" class="nav-link text-white" id="scheduleLink">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments') }}" class="nav-link text-white" id="appointmentsLink">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('doctor.profile.show') }}" class="nav-link text-white" id="dprofileLink">
